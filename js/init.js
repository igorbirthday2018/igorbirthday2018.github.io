...
var count = $('.text-container').length;
$('.text-container').addClass('hidden');

setTimeout(function () {
    $('.text-container:nth-child(1)').removeClass('hidden');
}, 1000);

setTimeout(function () {
    $('.text-container:nth-child(1)').addClass('hidden-2');
    $('.text-container:nth-child(2)').removeClass('hidden');
}, 3000);

setTimeout(function () {
    $('.text-container:nth-child(2)').addClass('hidden-2');
    $('.text-container:nth-child(3)').removeClass('hidden');
}, 5000);
    
setTimeout(function () {
    $('.text-container:nth-child(3)').addClass('hidden-2');
    $('.text-container:nth-child(4)').removeClass('hidden');
}, 7000);

setTimeout(function () {
    $('.text-container:nth-child(4)').addClass('hidden-2');
    $('.text-container:nth-child(5)').removeClass('hidden');
}, 9000);

setTimeout(function () {
    $('.text-container:nth-child(5)').addClass('hidden-2');
    $('.text-container:nth-child(6)').removeClass('hidden');
}, 11000);

setTimeout(function () {
    $('.text-container:nth-child(6)').addClass('hidden-2');
    $('.text-container:nth-child(7)').removeClass('hidden');
}, 13000);

setTimeout(function () {
    $('.text-container:nth-child(7)').addClass('hidden-2');
    $('.text-container:nth-child(8)').removeClass('hidden');
}, 15000);

setTimeout(function () {
    $('.text-container:nth-child(8)').addClass('hidden-2');
    $('.text-container:nth-child(9)').removeClass('hidden');
}, 17000);

setTimeout(function () {
    $('.text-container:nth-child(9)').addClass('hidden-2');
    $('.text-container:nth-child(10)').removeClass('hidden');
}, 19000);

setTimeout(function () {
    $('.text-container:nth-child(10)').addClass('hidden-2');
    $('.text-container:nth-child(11)').removeClass('hidden');
}, 21000);

setTimeout(function () {
    $('.text-container:nth-child(11)').addClass('hidden-2');
    $('.text-container:nth-child(12)').removeClass('hidden');
}, 23000);